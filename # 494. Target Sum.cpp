...
//O(ns) dp with continuous states. When hashtable is replaced by vector, test cases show significant runtime improvement. 
//#4 is theoretically better because it does not visit invalid states
class Solution {
public:
    int findTargetSumWays(vector<int>& nums, int S) {
